...
def test_example():
    return {'result': 'Hey Gopu, How are you?'}
...
def customer_churn_prediction():
    ...
    final_result = customer_churn_proc.make_predictions(data_dict, imp_cat_feats, imp_num_feats)
    final_result_output = {"result": final_result}
...
def loan_approval_prediction():
    ...
    final_result = loan_approval_proc.make_predictions(data_dict, imp_cat_feats)
    final_result_output = {"result": final_result}
    return final_result_output
...
def loan_repayment_prediction():
    ...
    final_result = loan_repayment_proc.make_predictions(data_dict, imp_cat_feats, imp_num_feats)
    final_result_output = {"result": final_result}
    return final_result_output
